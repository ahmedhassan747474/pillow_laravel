        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                 ...
                 Registeration
                 <form class="form-group"  action="{{route('submit-registeration')}}" method="POST"  >
                    {{ csrf_field() }}

                    {!! $errors->first('msg', '<div class="form-text  text-main error" >:message</div>') !!}
                    <div class="form-input">
                        <input class="form-control" placeholder="Name" name="name" id="email" value="{{old('name')}}">
                    </div>                    
                    {!! $errors->first('msg', '<div class="form-text  text-main error" >:message</div>') !!}
                    <div class="form-input">
                    ...
                    <div class="mt-30 text-center">
                        <button class="red-btn w-75 p-3 br20">Register</button>
                    </div>
