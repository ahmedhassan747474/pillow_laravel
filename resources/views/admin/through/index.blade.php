                ...
                <div class="card-content">
                    <div class="card-body text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                    <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$through->id}}" id="customSwitch{{$through->id}}" {{ $through->status == '1' ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customSwitch{{$through->id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5>{{$through->type == 1 ? trans('common.Travel Agency') : trans('common.Residential') }}</h5>
                            </div>
                        </div>
                        ...
                        <div class="card-btns d-flex justify-content-between">
                            <a href="{{route('show_through', $through->id)}}" class="btn btn-primary">{{trans('common.Show')}}</a>
                            <a href="{{route('edit_through', $through->id)}}" class="btn btn-warning">{{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_through', $through->id)}}" data-direct="{{route('throughs')}}" class="btn btn-danger delete-ajax">{{trans('common.Delete')}}</a>
                        </div>
