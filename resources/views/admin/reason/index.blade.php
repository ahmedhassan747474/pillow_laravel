                ...
                <div class="card-content">
                    <div class="card-body text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                    <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$reason->id}}" id="customSwitch{{$reason->id}}" {{ $reason->status == '1' ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customSwitch{{$reason->id}}">
                        ...
                        <div class="card-btns d-flex justify-content-between">
                            <a href="{{route('show_reason', $reason->id)}}" class="btn btn-primary">{{trans('common.Show')}}</a>
                            <a href="{{route('edit_reason', $reason->id)}}" class="btn btn-warning">{{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_reason', $reason->id)}}" data-direct="{{route('reasons')}}" class="btn btn-danger delete-ajax">{{trans('common.Delete')}}</a>
                        </div>
