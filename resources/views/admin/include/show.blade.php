        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{trans('common.Include Detail')}}</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$include->id}}" id="customSwitch100" {{ $include->status == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_include', $include->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_include', $include->id)}}" data-direct="{{route('includes')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
