        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.edit offer')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" novalidate action="{{route('update_offer', $offer->id)}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" class="form-control" data-validation-containsnumber-regex="^[a-zA-Z\s]+$" data-validation-required-message="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Name')}}" value="{{ $offer->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="country" data-validation-required-message="{{trans('common.This field is required')}}" required>
                                            ...
                                            <option value="{{$country->code}}" {{$offer->phone_code == $country->code ? 'selected' : ''}}>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="phone" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter Phone Number')}}" value="{{ $offer->phone_number }}">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="media">
                                        <a href="javascript: void(0);">
                                            <img src="{{$offer->image}}" class="rounded mr-75" alt="profile image" height="64" width="64">
                                        </a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="email" name="email" class="form-control" data-validation-required-message="{{trans('common.Must be a valid email')}}" placeholder="{{trans('common.Enter Email')}}" value="{{ $offer->email }}">
                                        </div>
                                    </div>
