...
@endsection
@section('page_title')
{{trans('common.Shared Room Detail')}}  
@endsection
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="users-view-image">
                            <img src="{{$room['image']}}" class="users-avatar-shadow w-100 rounded mb-2 pr-2 ml-1" alt="avatar">
                        </div>
                        <div class="col-12 col-sm-9 col-md-6 col-lg-5">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$room['country_name']}}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.City')}}</td>
                                    <td class="text-center">{{$room['city_name']}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$room['discount']}}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Discount Type')}}</td>
                                    <td class="text-center">{{$room['discount_type']}}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Price After Discount')}}</td>
                                    <td class="text-center">{{$room['after_discount']}}</td>
                                </tr>
                                @endif
                                <tr>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="is_hot_deal" {{$room['is_hot_deal'] == '1' ? 'checked' : ''}} disabled>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-success">
                                                    <input type="checkbox" name="is_cheapest" {{$room['is_cheapest'] == '1' ? 'checked' : ''}} disabled>
                                                    <span class="vs-checkbox">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-danger">
                                                    <input type="checkbox" name="is_popular" {{$room['is_popular'] == '1' ? 'checked' : ''}} disabled>
                                                    <span class="vs-checkbox">
                                                        <span class="vs-checkbox--check">
                                                            <i class="vs-icon feather icon-check"></i>
                                                        </span>
                        ...
                        <div class="col-12 col-md-12 col-lg-5">
                            <table class="ml-0 ml-sm-0 ml-lg-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$room['per']}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$room['num_of_adult']}}</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Number of Child')}}</td>
                                    <td class="text-center">{{$room['num_of_child']}}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$room['id']}}" id="customSwitch100" {{ $room['status'] == '1' ? 'checked' : '' }}>
                                    ...
                                    <td>
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="d-inline-block mr-2">
                                                <fieldset>
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" name="attributes[{{$attribute->id}}]" {{checkAttribute($room['attributes'], $attribute->id, 'show')}} disabled>
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_room', $room['id'])}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_room', $room['id'])}}" data-direct="{{route('rooms')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{$room['images'][0]['name']}}" class="img-fluid d-block w-100" alt="cf-img-1" style="height: 400px;">
                            </div>
        ...
        <div class="col-md-6 col-12 ">
            <div class="card">
                ...
                <div class="card-body">
                    <iframe width="100%" height="400" src="https://maps.google.com/maps?q={{$room['latitude']}},{{$room['longitude']}}&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                </div>
            </div>
        </div>
        <!-- Map start -->
