...
<section id="dashboard-analytics">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <p class="mb-0">{{trans('common.reservations')}} Received</p>
                </div>
                <div class="card-content">
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{ $results['accept'] }}</h2>
                    <p class="mb-0">{{ trans('common.Accepted') }}</p>
                </div>
                <div class="card-content">
                    <div id="accept"></div>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <p class="mb-0">{{ trans('common.Pending') }}</p>
                </div>
                <div class="card-content">
                    <div id="pending"></div>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{ $results['reject'] }}</h2>
                    <p class="mb-0">{{ trans('common.Rejected') }}</p>
                </div>
                <div class="card-content">
                    <div id="reject"></div>
                </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1">{{ $results['cancel'] }}</h2>
                    <p class="mb-0">{{ trans('common.Canceled') }}</p>
                </div>
                <div class="card-content">
                    <div id="cancel"></div>
                </div>
    ...
    <div class="row">
        {{-- <div class="col-lg-8 col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body pb-0" style="height: 33em;">
                        ...
                        <div id="revenue-chart" style="margin-top: 3em"></div>
                    </div>
                </div>
            </div>
        </div> --}}
    ...
    {{-- <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ trans('common.reservations') }}</h4>
                </div>
                <div class="card-content">
