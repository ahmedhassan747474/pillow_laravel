            ...
            <div class="card">
                <div class="card-header mx-auto">
                    <div class="avatar avatar-xl">
                        <img class="img-fluid" src="{{asset($gallary->name)}}" alt="img placeholder">
                    </div>
                </div>
                <div class="card-content">
                    <div class="card-body text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                    <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$gallary->id}}" id="customSwitch{{$gallary->id}}" {{ $gallary->status == '1' ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customSwitch{{$gallary->id}}">
                        ...
                        <div class="card-btns d-flex justify-content-between">
                            <a href="{{route('show_gallary', $gallary->id)}}" class="btn btn-primary">{{trans('common.Show')}}</a>
                            <button data-url="{{route('delete_gallary', $gallary->id)}}" data-direct="{{route('gallaries')}}" class="btn btn-danger delete-ajax">{{trans('common.Delete')}}</a>
                        </div>
