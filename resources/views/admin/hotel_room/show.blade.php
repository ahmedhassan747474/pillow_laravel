                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-9 col-md-6 col-lg-5">
                            <table>
                                ...
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Refundable')}}</td>
                                    <td class="text-center">{{$room['refund']}}</td>
                                </tr>

                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Payment Receipt')}}</td>
                                    <td class="text-center">{{$room['payment_receipt']}}</td>
                                </tr>

                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Include')}}</td>
                                    <td class="text-center">{{$room['include']}}</td>
                                </tr>
                        ...
                        <div class="col-12 col-md-12 col-lg-5">
                            <table class="ml-0 ml-sm-0 ml-lg-0">
                                ...
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Number of Bed')}}</td>
                                    <td class="text-center">{{$room['num_of_bed']}}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_hotel_room', $room['id'])}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_hotel_room', $room['id'])}}" data-direct="{{route('hotels')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
