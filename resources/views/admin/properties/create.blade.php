        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create hotel')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" validate action="{{route('store_hotel')}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                <div class="col-md-6">

                                    <div class="form-group">
                                        <label>{{trans('common.Enter Hotel Name')}}</label>
                                        <div class="controls">
                                            <input type="text" name="name_en" class="form-control" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Hotel Name ')}}" value="{{ old('name_en') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_ar" class="form-control" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Hotel Name Arabic')}}" value="{{ old('name_ar') }}" required>
                                        </div>
                                    </div> --}}

                                    <div class="form-group">
                                        <label>{{trans('common.Enter Hotel Description ')}}</label>
                                        <div class="controls">
                                            ...
                                            placeholder="{{trans('common.Enter Hotel Description ')}}" required>{{ old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            oninvalid="this.setCustomValidity('{{trans('common.This field is required')}}')"
                                            onchange="this.setCustomValidity('')"
                                            placeholder="{{trans('common.Enter Hotel Description Arabic')}}">{{ old('description_ar') }}</textarea>
                                        </div>
                                    </div> --}}
