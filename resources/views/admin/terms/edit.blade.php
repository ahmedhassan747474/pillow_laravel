        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.edit term')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" validate action="{{route('update_term', $term->id)}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                {{-- <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select class="form-control country" name="type" required>
                                                ...
                                                <option value="0" {{ old('type', $term->type ) == '0' ? 'selected' : null }}>{{__('Term') }}</option>
                                                <option value="1" {{ old('type', $term->type ) == '1' ? 'selected' : null }}>{{__('Condition') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="name" class="form-control summernote" data-error="{{trans('common.This field is required')}}"  id="summernote" required rows="10">
                                                {{ $term->name }}
                                            </textarea>
                                        </div>
                                    </div>
