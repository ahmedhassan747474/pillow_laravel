        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{trans('common.Coupon Detail')}}</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{{$coupon->type == 'percent' ? trans('common.percent') : trans('common.price')}}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$coupon->id}}" id="customSwitch100" {{ $coupon->status == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_coupon', $coupon->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_coupon', $coupon->id)}}" data-direct="{{route('countries')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
