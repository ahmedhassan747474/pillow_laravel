                ...
                <div class="card-body">
                    <div class="row">
                        <div class="users-view-image">
                            <img src="{{$admin->image}}" class="users-avatar-shadow w-100 rounded mb-2 pr-2 ml-1" alt="avatar">
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$admin->id}}" id="customSwitch100" {{ $admin->status == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_admin', $admin->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_admin', $admin->id)}}" data-direct="{{route('admins')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
