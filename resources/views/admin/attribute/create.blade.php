        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create attribute')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" validate action="{{route('store_attribute')}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                {{-- <div class="col-md-6">
