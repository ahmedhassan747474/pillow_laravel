        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{trans('common.Book List Detail')}}</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{{$book->type == 1 ? trans('common.Travel Agency') : trans('common.Business Space') }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$book->id}}" id="customSwitch100" {{ $book->status == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_book', $book->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_book', $book->id)}}" data-direct="{{route('books')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
