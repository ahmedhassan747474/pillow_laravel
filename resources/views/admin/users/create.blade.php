        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create user')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" novalidate action="{{route('store_user')}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="surename" class="form-control" data-validation-containsnumber-regex="^[a-zA-Z]+$" data-validation-required-message="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Surename')}}" value="{{ old('surename') }}">
                                        </div>
                                    </div>
