                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-9 col-md-6 col-lg-5">
                            <table>
                                ...
                                <tr>
                                    <td class="font-weight-bold">{{trans('common.Surename')}}</td>
                                    <td>{{$user->surename}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch switch-lg custom-switch-success mr-2">
                                            <input type="checkbox" class="custom-control-input toggle-class" data-id="{{$user->id}}" id="customSwitch100" {{ $user->status == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <a href="{{route('edit_user', $user->id)}}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> {{trans('common.Edit')}}</a>
                            <button data-url="{{route('delete_user', $user->id)}}" data-direct="{{route('users')}}" class="btn btn-danger delete-ajax"><i class="feather icon-trash-2"></i> {{trans('common.Delete')}}</button>
                        </div>
                    </div>
                </div>
            </div>
