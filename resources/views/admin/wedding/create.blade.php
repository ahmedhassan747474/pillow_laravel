...
@endsection
@section('page_title')
{{trans('common.create wedding hall')}}
@endsection
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create wedding hall')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" validate action="{{route('store_wedding')}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_en" class="form-control" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Wedding Hall Name English')}}" value="{{ old('name_en') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_ar" class="form-control" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Wedding Hall Name Arabic')}}" value="{{ old('name_ar') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            placeholder="{{trans('common.Enter Wedding Hall Description English')}}" required>{{ old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            oninvalid="this.setCustomValidity('{{trans('common.This field is required')}}')" 
                                            onchange="this.setCustomValidity('')"  
                                            placeholder="{{trans('common.Enter Wedding Hall Description Arabic')}}">{{ old('description_ar') }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type='text' name="book_in" class="form-control format-picker-mine" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Book In Date')}}" value="{{ old('book_in') }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type='text' name="start_time" class="form-control format-pickatime-mine" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter Start Time')}}" value="{{ old('start_time') }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type='text' name="end_time" class="form-control format-pickatime-mine" data-error="{{trans('common.This field is required')}}" placeholder="{{trans('common.Enter End Time')}}" value="{{ old('end_time') }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="guest_number" class="form-control" required pattern="(\d)+" data-error="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter Guest Number')}}" value="{{ old('guest_number') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="hall_size" class="form-control" required pattern="(\d)+" data-error="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter Hall Size')}}" value="{{ old('hall_size') }}">
                                        </div>
                                    </div>
