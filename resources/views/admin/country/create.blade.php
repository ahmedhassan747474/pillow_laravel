        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create country')}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" validate action="{{route('store_country')}}" method="POST" enctype="multipart/form-data">
                            @CSRF
                            {{-- <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="inputGroupFile01" name="flag" data-error="{{trans('common.This field is required')}}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="code" class="form-control" pattern="(\d)+" data-error="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter Country Code')}}" value="{{ old('code') }}" required>
                                        </div>
                                    </div> --}}
